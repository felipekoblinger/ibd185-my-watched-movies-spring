...
public class MovieStatisticsControllerTest {
    @Autowired
    ...
    public void testOverall() throws Exception {
        SecurityAccount securityAccount =
                (SecurityAccount) userDetailsService.loadUserByUsername("rodrikflint");
        assertNotNull("Account not found", securityAccount);

        String token = tokenUtil.generateToken(securityAccount);

        mockMvc.perform(get("/movies-statistics/overall/")
    ...
    @Test
    public void testOverallWithoutAuthorization() throws Exception {
        mockMvc.perform(get("/movies-statistics/overall/"))
                .andDo(print())
    ...
    @Test
    public void testOverallWithWrongRole() throws Exception {
        SecurityAccount securityAccount =
